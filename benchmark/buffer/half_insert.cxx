...
NONIUS_BENCHMARK("ffs buffer insert", [](nonius::chronometer meter) {
    ...
    std::generate_n(std::back_inserter(fills), ffs_bfr.capacity() / 2, insert_fn);
